...
- `SlotIQ.Administration.Common.Models.Result<T>` - For the Result pattern
- `SlotIQ.Administration.Common.Helpers.ResultExtensions` - For Result extensions
- `SlotIQ.Administration.Common.Models.PaginatedResult<T>` - For pagination
- `SlotIQ.Administration.Common.Constants.ErrorMessages` - For error messages