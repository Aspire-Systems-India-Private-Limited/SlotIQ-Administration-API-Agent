---
applyTo: SlotIQ.Administration.API/**/*.cs
...
- `{{ProjectPrefix}}`: root namespace (e.g., SlotIQ.Administration)
...
## Endpoint Structure
- File: `SlotIQ.Administration.API/Endpoints/{{EntityName}}Endpoints.cs`
