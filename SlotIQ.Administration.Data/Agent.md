---
applyTo: SlotIQ.Administration.Data/**/*.cs, SlotIQ.Administration.Data/**/*.sql
...
Store all SQL queries in `SlotIQ.Administration.Data/Sql/` folder:
...
- **SlotIQ.Administration.Common**: For Result<T>, ErrorMessages, and enums
